...
export default function Gallery() {
  ...
  return (
    <section className="my-4">
      ...
      <dialog
        ref={dialogRef}
        className="w-[80%] h-[80%] bg-primary-200 rounded relative p-4"
      >
        <div className="w-full h-full flex items-center justify-center">
          {selectedImage !== null && (
            <Image
              ...
              height={600}
              alt={"popup"}
              className="rounded transform transition-transform duration-300 ease-in-out scale-100 hover:scale-105 w-full h-auto max-h-full"
            />
          )}
        </div>
