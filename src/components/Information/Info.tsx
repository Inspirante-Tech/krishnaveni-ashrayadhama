...
const Info: React.FC = () => {
    ...
    return (
        <div
            ...
            } shadow-lg p-3 mt-8 md:p-4 md:mt-10 bg-secondary-100 rounded-lg text-justify `}
        >
           <h2 className="text-center text-4xl md:text-5xl font-bold font-poppins tracking-tight text-gray-900  mb-8  pt-6">Our Story</h2>
            <div>
